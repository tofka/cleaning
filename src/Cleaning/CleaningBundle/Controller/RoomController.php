...
use Cleaning\CleaningBundle\Entity\Room;
use Cleaning\CleaningBundle\Form\RoomType;
...
class RoomController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CleaningBundle:Room')->findAll();
     ...
     * @Method("POST")
     * @Template("CleaningBundle:Room:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CleaningBundle:Room')->find($id);
     ...
     * @Method("PUT")
     * @Template("CleaningBundle:Room:edit.html.twig")
     */
